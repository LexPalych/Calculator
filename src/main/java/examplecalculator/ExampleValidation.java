...
final class ExampleValidation {
    ...
    private ExampleValidation(String example) {
    ...
    public static void isCorrect(String example) {
        ExampleValidation exampleValidation = new ExampleValidation(example);

        exampleValidation.checkIncorrectSigns();
        exampleValidation.checkBracketAmount();
        exampleValidation.checkBracketOrder();
        exampleValidation.checkArgumentBracket();
        exampleValidation.checkExpressionInBracketIsCorrect();
        exampleValidation.checkSymbolBeforeFunction();
        exampleValidation.checkSymbolAfterFunction();
        exampleValidation.checkSeveralSignConsecutive();
        exampleValidation.checkFirstSymbol();
        exampleValidation.checkLastSymbol();
